...
The _images_ directory is for your images. Add your image files here and use the `Image` component to render them in pages.
...
The _navs_ directory is for navigation menus. Add your menus here and use the `NavMenu` component to place theme in blocks or pages.
