...
Yes. Color modes, presets, variants and all other features of Theme UI is supported.
...
You can use a pipe `|` for responsive values or array-like syntax. They are both supported.

```jsx
<Div mt="2|4|8" />
```

#### How do use hover, focus and other Pseudo-classes?
